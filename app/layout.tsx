...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "/immiGrow_official_final.svg?v=14",
    apple: "/immiGrow_official_final.svg?v=14",
  },
  openGraph: {
    title: "immiGrow Dublin | Salud, Actividad y Comunidad",
    ...
    images: [
      {
        url: "https://www.immigrow.ie/immiGrow_official_final.svg?v=14",
        width: 1024,
        height: 1024,
        alt: "immiGrow Logo",
      },
  ...
  twitter: {
    ...
    title: "immiGrow Dublin | Salud, Actividad y Comunidad",
    description: "Salud, bienestar y trámites para migrantes en Dublín.",
    images: ["https://www.immigrow.ie/immiGrow_official_final.svg?v=14"],
  },
  appleWebApp: {
    capable: true,
  ...
  other: {
    ...
    "apple-touch-icon": "https://www.immigrow.ie/immiGrow_official_final.svg?v=14",
