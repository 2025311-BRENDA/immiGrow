...
export function SlangDictionary() {
    ...
    const data = language === "en" ? dublinSlang : dublinSlangEs;
        ...
        <section className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h3 className="text-2xl font-black text-brand-navy">
                        {language === "en" ? "Speak like a Local" : "Habla como un local"}
                    </h3>
                    <p className="text-slate-500 text-sm mt-1">
                        {language === "en" ? "Common Dublin phrases and what they actually mean." : "Frases comunes de Dublín y lo que realmente significan."}
                    </p>
                </div>
            </div>
            ...
            <div className="mt-10 p-6 bg-brand-purple text-white rounded-[2rem] shadow-inner relative overflow-hidden">
                ...
                <h5 className="font-bold mb-2 flex items-center gap-2">
                    ...
                    {language === "en" ? "Pro Tip" : "Consejo Pro"}
                </h5>
